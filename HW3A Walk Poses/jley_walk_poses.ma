...
//Name: jley_walk_poses.ma
//Last modified: Sun, Sep 24, 2023 03:28:05 PM
//Codeset: 1252
...
fileInfo "UUID" "CF0F19F7-4EAC-29E4-2500-5E950B25042B";
createNode transform -s -n "persp";
	rename -uid "0C36ED7A-457C-0484-AF20-83B865EC7E53";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 17.337994659692495 3.7508679006162362 1.0646535882185522 ;
	setAttr ".r" -type "double3" -11.138352729642115 89.3999999999983 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "EDD0ED64-4A38-E9EE-36A5-9F90524F37B3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 17.972832559950209;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5AEA4E0F-41B7-94A3-BB98-7F84EF133E3D";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "123A384E-43DF-129E-0431-709451BC2BF6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "581DAFF4-47B0-F013-6F63-588EF6C5C47C";
createNode displayLayerManager -n "layerManager";
	rename -uid "56BB8A4E-42E7-4A02-AED7-6397E0C68F09";
createNode displayLayer -n "defaultLayer";
	rename -uid "02AA72E7-4D13-751A-7737-C9A6BEE4AC1E";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "006814EA-4B61-0036-7E0F-92B6FFF305F2";
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 7 0 10 0 13 0 19 0.227 22 0.182 24 0;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateZ";
	...
	setAttr -s 6 ".ktv[0:5]"  1 0.087 10 0.087 13 0.087 19 0.53 22 2.818
		 24 4.075;
	setAttr -s 6 ".kot[0:5]"  5 5 5 5 18 5;
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footRoll";
	rename -uid "AC4B72AA-4F88-8B9F-CEEB-ABA93E5E74FF";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 -25 4 0 10 0 13 25 16 38 19 80 22 30 24 -25;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footBreak";
	rename -uid "C21A1C39-4FBB-994E-5CB5-96828E1D266F";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 10 0 13 45 16 0;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
createNode animCurveTL -n "CTRL_Main_translateY";
	rename -uid "DBA85CC6-4F8A-C180-D7C8-628FB13784D6";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 -0.077 4 -0.077 7 0 10 -0.218 13 -0.077
		 19 0 22 -0.218 24 -0.077;
...
createNode animCurveTL -n "CTRL_Main_translateZ";
	...
	setAttr -s 9 ".ktv[0:8]"  1 0.884 4 0.13 7 -0.074 10 -0.9 13 -1.105
		 16 -1.859 19 -2.206 22 -2.889 24 -3.034;
...
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 4 0 7 0.227 10 0.18 13 0 22 0 24 0;
	setAttr -s 7 ".kot[0:6]"  5 5 5 5 5 18 5;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateZ";
	rename -uid "1B45A34A-459D-B902-7864-ACAFCB789379";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 -1.935 4 -1.935 7 -1.469 10 0.833 13 2.075
		 22 2.075 24 2.075;
	setAttr -s 7 ".kot[0:6]"  5 5 5 5 5 18 5;
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footRoll";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 25 4 40 7 80 10 30 13 -25 16 0 22 0 24 25;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 18 5;
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footBreak";
	rename -uid "FC9C0E0C-4661-FBBE-B886-16B3E85AF9DA";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 45 4 0 7 0 10 0 13 0 22 0 24 45;
	setAttr -s 7 ".kot[0:6]"  5 5 5 5 5 18 5;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
...
connectAttr "walker_lf_heel_ik_ctrl_translateZ.o" "Ultimate_Walker_RigRN.phl[2]"
		;
connectAttr "walker_lf_heel_ik_ctrl_footRoll.o" "Ultimate_Walker_RigRN.phl[3]";
connectAttr "walker_lf_heel_ik_ctrl_footBreak.o" "Ultimate_Walker_RigRN.phl[4]";
...
connectAttr "walker_rt_heel_ik_ctrl_translateZ.o" "Ultimate_Walker_RigRN.phl[6]"
		;
connectAttr "walker_rt_heel_ik_ctrl_footRoll.o" "Ultimate_Walker_RigRN.phl[7]";
connectAttr "walker_rt_heel_ik_ctrl_footBreak.o" "Ultimate_Walker_RigRN.phl[8]";
connectAttr "CTRL_Main_translateY.o" "Ultimate_Walker_RigRN.phl[9]";
connectAttr "CTRL_Main_translateZ.o" "Ultimate_Walker_RigRN.phl[10]";
