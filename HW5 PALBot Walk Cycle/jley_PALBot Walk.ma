...
//Last modified: Wed, Oct 25, 2023 12:41:52 PM
//Codeset: 1252
...
fileInfo "UUID" "31DB3BB8-47C1-FA42-D5B0-1EB8905AB2B0";
createNode transform -s -n "persp";
	rename -uid "B3D1CACA-412E-9156-F444-8B8F46133BFA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -35.765406115972233 19.176123502905828 26.369375783699773 ;
	setAttr ".r" -type "double3" -13.200000000002589 -54.39999999999965 1.3659290409911604e-15 ;
...
createNode transform -n "walkRef";
	...
	setAttr ".t" -type "double3" 5.0554069234594916 18.734831035021411 20.927945148029124 ;
	setAttr ".r" -type "double3" 0 -90 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4A979C8D-42AD-1C6D-CA9A-97A344643DE4";
	setAttr -s 32 ".lnk";
	setAttr -s 32 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7A5109E2-4ADA-C6CF-1F2D-9CAEE4A77CA8";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5FF2361F-48FE-A645-B92C-BF8C9AF744CB";
createNode displayLayerManager -n "layerManager";
	rename -uid "B5AB5F0E-4A5E-4C8A-357F-D3B92BA23E28";
	setAttr ".cdl" 1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C3D01053-4FC0-EA56-A6CC-A0AC6011C502";
...
createNode reference -n "PALBotRN";
	...
	setAttr ".fn[0]" -type "string" "D:/GitHub Repositories/DAGV2440-Animation-1/HW5 PALBot Walk Cycle/PALBOT/PALBot.ma";
	setAttr -s 24 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0 -0.734 -0.27432944086320576"
...
createNode reference -n "sharedReferenceNode";
	rename -uid "49F6FB9B-4FF4-E087-72E6-12974B2F8A75";
	setAttr ".ed" -type "dataReferenceEdits" 
		"sharedReferenceNode";
select -ne :time1;
	setAttr -av -k on ".cch";
